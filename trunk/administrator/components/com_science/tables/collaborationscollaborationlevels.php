 ...
 * @subpackage		Science
 */
class TableCollaborationscollaborationlevels extends JTable {

	var $id = null;
	var $collaboration_id = null;
	var $collaboration_level_id = null;
	...
	function __construct(& $db) {
		parent::__construct('#__sci_collaborations_collaboration_levels', 'id', $db);
	}
	 ...
	 */
	function delete_all_collaboration_levels( $oid=null )
	{
		$k = $this->_tbl_key;
		if ($oid) {
			$this->$k = intval( $oid );
