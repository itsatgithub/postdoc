...
<?php echo $this->params->get( 'page_title' ); ?></div>
<?php endif; ?>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0"
	...
	<tr>
		...
		<form action="<?php echo JRoute::_('index.php') ?>" method="post"
			name="selectForm" id="selectForm"><?php echo JText::_( 'Select Contact' ); ?>:
		<br />
		...
		<input type="hidden" name="option" value="com_contact" /></form>
		</td>
	</tr>
	<?php endif; ?>
	...
	<tr>
		<td width="100%"
			...
			<?php echo $this->escape($this->contact->name); ?></td>
	</tr>
	<?php endif; ?>
	...
	<tr>
		...
		<table border="0" width="100%">
			<tr>
				...
				<div style="float: right;"><?php echo JHTML::_('image', 'images/stories' . '/'.$this->contact->image, JText::_( 'Contact' ), array('align' => 'middle')); ?>
				</div>
				<?php endif; ?></td>
			</tr>
			<tr>
	...
	<tr>
		...
		<a
			href="<?php echo JURI::base(); ?>index.php?option=com_contact&amp;task=vcard&amp;contact_id=<?php echo $this->contact->id; ?>&amp;format=raw&amp;tmpl=component">
			<?php echo JText::_( 'VCard' );?></a></td>
	</tr>
	<?php endif;
