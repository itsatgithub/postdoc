...
<table width="100%" class="table">
	...
	<tr class="sectiontableentry1">
		<td width="15%" valign="top"><?php echo JText::_('PHDLECTURE_DATE'); ?>:
		</td>
		<td><?php if ($this->rights == 'write'): ?> <input 
			type="text" name="expected_lecture" value="<?php echo $this->applicant->expected_lecture; ?>" size="50" /> <?php else: 
...
<table width="100%" class="table">
	...
	<tr class="sectiontableentry1">
		...
		echo $this->applicant->committee_list[0]->name; ?> <?php endif; ?></td>
	</tr>
	<tr class="sectiontableentry1">
		<td><?php echo JText::_('RESP_COMMITTEE'); ?>:</td>
		<td><?php if ($this->rights == 'write'):
		...
		echo $this->applicant->committee_list[1]->name; ?> <?php endif; ?></td>
	</tr>
	<tr class="sectiontableentry1">
		<td><?php echo JText::_('RESP_COMMITTEE'); ?>:</td>
		<td><?php if ($this->rights == 'write'):
		...
		echo $this->applicant->committee_list[2]->name; ?> <?php endif; ?></td>
	</tr>
	<?php endif; ?>
	<tr class="sectiontableentry1">
		<td align="left">
